...
export const site = {
  ...
  fullName: "Muhammad Isyraf Afifi",

  /** Initials (kept for the dormant 3D hero variant). */
  initials: "MIA",
  ...
  avatar: {
    src: "/avatar.svg",
    alt: "Illustrated portrait of Muhammad Isyraf Afifi wearing headphones and a hoodie",
  },
