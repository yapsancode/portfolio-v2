...
const PageCard: React.FC<SkillCardProps> = ({
  title,
  description,
  icon,
  ...
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
      className={`${sizeClasses[size]} ${gradient} rounded-3xl p-6 md:p-8 shadow-sm hover:shadow-xl transition-all duration-300 cursor-pointer relative overflow-hidden group border border-gray-700`}
      onClick={onClick}
