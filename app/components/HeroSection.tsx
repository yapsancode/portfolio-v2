                ...
                <div className="flex-1 text-center md:text-left">
                    ...
                    <div className="mb-6">
                        <TypeAnimation
                            ...
                            className={`${courierPrime.className} text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto md:mx-0 leading-relaxed`}
                            repeat={Infinity}
                        />
                    </div>
                    ...
                    {/* Short Story / Journey */}
                    <motion.p
                        className="text-base md:text-lg text-white-700 dark:text-white-400 max-w-2xl mx-auto md:mx-0 leading-relaxed"
                    ...
                    {/* <div className="mt-8 flex flex-wrap gap-4 justify-center md:justify-start">
                        ...
                        <motion.a
                            href="#contact"
                            className="px-6 py-3 rounded-2xl border border-purple-600 text-purple-600 dark:text-purple-400 font-semibold hover:bg-purple-600 hover:text-white transition"
                            whileHover={{ scale: 1.05 }}
                        >
                            Contact Me
                        </motion.a>
